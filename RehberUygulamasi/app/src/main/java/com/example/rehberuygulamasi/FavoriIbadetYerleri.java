...
public class FavoriIbadetYerleri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favori_ibadet_yerleri);

        Query query = FirebaseDatabase.getInstance().getReference("Kategoriler").child("Ibadet Yerleri")
                .orderByChild("puan")
                .startAt(4);
