...
public class FavoriTarihiYerler extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favori_tarihi_yerler);

        Query query = FirebaseDatabase.getInstance().getReference("Kategoriler").child("Tarihi Yerler")
                .orderByChild("puan")
                .startAt(4);
