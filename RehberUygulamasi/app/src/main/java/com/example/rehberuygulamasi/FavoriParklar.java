...
public class FavoriParklar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favori_parklar);

        Query query = FirebaseDatabase.getInstance().getReference("Kategoriler").child("Parklar")
                .orderByChild("puan")
                .startAt(4);
