...
public class FavoriOtoparklar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favori_otoparklar);

        Query query = FirebaseDatabase.getInstance().getReference("Kategoriler").child("Otoparklar")
                .orderByChild("puan")
                .startAt(4);
