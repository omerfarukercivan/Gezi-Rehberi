...
public class FavoriKutuphaneler extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favori_kutuphaneler);

        Query query = FirebaseDatabase.getInstance().getReference("Kategoriler").child("Kutuphaneler")
                .orderByChild("puan")
                .startAt(4);
