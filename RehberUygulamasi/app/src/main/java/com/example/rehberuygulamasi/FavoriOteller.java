...
public class FavoriOteller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favori_oteller);

        Query query = FirebaseDatabase.getInstance().getReference("Kategoriler").child("Oteller")
                .orderByChild("puan")
                .startAt(4);
